...
1. **002-checkout-antifraude-mercadopago** [finished] — Alinha o checkout às exigências antifraude do Mercado Pago: protege o script de Device ID no LiteSpeed, corrige o campo de Nome da Empresa escondido no mobile para Pessoa Jurídica, e confirma validação/obrigatoriedade dos campos PF/PJ.
