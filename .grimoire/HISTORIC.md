...
1. **003-checkout-mobile-responsiveness** [spec] — Corrige responsividade do checkout no mobile: desalinhamento Número/Complemento, sobreposição do balão do WhatsApp sobre o formulário, e reavaliação segura do fix de padding do #main-content.
